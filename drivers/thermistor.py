...
class Thermistor:
    def __init__(self, pin_adc: ADC, beta: int, therm_ohm: int, divider_ohm: int):
        self.pin = pin_adc
        self.beta = beta
    ...
    def read_resistance(self):
        """
        Assumes a voltage divider with ground side thermistor, provides the resistance across the thermistor based on voltage drop.
        """
